...
from phobos_torizon_io_api.configuration import Configuration
from phobos_torizon_io_api.api_response import ApiResponse, T as ApiResponseT
import phobos_torizon_io_api.models
from phobos_torizon_io_api import rest
from phobos_torizon_io_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(phobos_torizon_io_api.models, klass)
