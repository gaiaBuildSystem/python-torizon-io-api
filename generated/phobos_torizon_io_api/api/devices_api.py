...
from phobos_torizon_io_api.api_client import ApiClient, RequestSerialized
from phobos_torizon_io_api.api_response import ApiResponse
from phobos_torizon_io_api.rest import RESTResponseType
...
class DevicesApi:
    ...
    def get_devices(
        ...
        tag_regex: Optional[StrictStr] = None,
        ...
        """Query device information
         ...
         Retrieves a list of devices in your repository. This endpoint has two different modes of operation.  * You can specify `deviceId`s and/or `deviceUuid`s any number of times as query parameters, and all devices matching those ids will be returned. * You can specify a number of different filter parameters, and only devices matching all of the filter parameters you specify will be returned. Available filter parameters:     * `nameContains`     * `hibernated`     * `status`     * `activatedAfter`     * `activatedBefore`     * `lastSeenStart`     * `lastSeenEnd`     * `createdAtStart`     * `createdAtEnd`     * `tags`     * `tagRegex`      When specifying `tags`, you cannot specify any other filter parameter. `tags` must have the format `<tagid>=<tag value>`      The `tagRegex` parameter allows filtering devices by tag name and a regular expression pattern for the tag value.     Format: `<tag_name>=<regex_pattern>` where `tag_name` must be a valid tag identifier ([\\w\\-_]{1,20})     and `regex_pattern` is a valid regular expression (up to 50 characters) that will be matched against the tag value.     
    ...
    def _get_devices_serialize(
        ...
        if tag_regex is not None:
            ...
            _query_params.append(('tagRegex', tag_regex))
    ...
    @validate_call
    def get_devices_tags_deviceuuid(
        self,
        device_uuid: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_devices_tags_deviceuuid_serialize(
            device_uuid=device_uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_devices_tags_deviceuuid_with_http_info(
        self,
        device_uuid: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_devices_tags_deviceuuid_without_preload_content(
        self,
        device_uuid: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_devices_tags_deviceuuid_serialize(
        self,
        device_uuid,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/devices/tags/{deviceUuid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_devices_tags_deviceuuid(
        self,
        device_uuid: StrictStr,
        request_body: Dict[str, Optional[Annotated[str, Field(strict=True, max_length=50)]]],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Update the tags/attributes for a specific device
         ...
         Updates the tags/attributes for a specific device. If a tag already exists, it's value will be overwritten, otherwise the tag will be created.  If the value of the tag/attribute is null, the tag will be deleted.         
        ...
        _param = self._patch_devices_tags_deviceuuid_serialize(
            device_uuid=device_uuid,
    ...
    @validate_call
    def patch_devices_tags_deviceuuid_with_http_info(
        self,
        device_uuid: StrictStr,
        request_body: Dict[str, Optional[Annotated[str, Field(strict=True, max_length=50)]]],
        _request_timeout: Union[
    ...
    @validate_call
    def patch_devices_tags_deviceuuid_without_preload_content(
        self,
        device_uuid: StrictStr,
        request_body: Dict[str, Optional[Annotated[str, Field(strict=True, max_length=50)]]],
        _request_timeout: Union[
    ...
    def _patch_devices_tags_deviceuuid_serialize(
        self,
        device_uuid,
        request_body,
        _request_auth,
