...
class FleetsApi:
    ...
    def get_fleets(
        ...
        """Get information about all fleets in your repository
         ...
         Returns a list of fleets along with their UUIDs. You can filter the results by name using the nameContains parameter and sort them using the sortBy parameter.         
    ...
    @validate_call
    def get_fleets_fleetid_hardware_ids(
        self,
        fleet_id: UUID,
        offset: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        ...
        _param = self._get_fleets_fleetid_hardware_ids_serialize(
            fleet_id=fleet_id,
            offset=offset,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_fleets_fleetid_hardware_ids_with_http_info(
        self,
        fleet_id: UUID,
        offset: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginationResultRefined]:
        """Get all hardware IDs for devices in a fleet
    ...
    @validate_call
    def get_fleets_fleetid_hardware_ids_without_preload_content(
        self,
        fleet_id: UUID,
        offset: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
    ...
    def _get_fleets_fleetid_hardware_ids_serialize(
        self,
        fleet_id,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/fleets/{fleetId}/hardware-ids',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
