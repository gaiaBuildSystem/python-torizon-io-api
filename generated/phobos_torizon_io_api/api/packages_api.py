...
class PackagesApi:
    ...
    def get_packages(
        ...
        has_sbom: Optional[StrictBool] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _get_packages_serialize(
        ...
        if has_sbom is not None:
            ...
            _query_params.append(('hasSBOM', has_sbom))
