...
class DeviceInfoExtended(BaseModel):
    ...
    tags: Dict[str, Annotated[str, Field(strict=True, max_length=50)]]
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.device_fleets:
            for _item_device_fleets in self.device_fleets:
                _items.append(_item_device_fleets.to_dict() if _item_device_fleets is not None else None)
        ...
        if self.device_packages:
            for _item_device_packages in self.device_packages:
                _items.append(_item_device_packages.to_dict() if _item_device_packages is not None else None)
