...
class UpdateRequest(BaseModel):
    ...
    devices: Optional[Annotated[List[UUID], Field(max_length=50)]] = None
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.custom:
            for _key_custom in self.custom:
                _field_dict[_key_custom] = self.custom[_key_custom].to_dict() if self.custom[_key_custom] is not None else None
