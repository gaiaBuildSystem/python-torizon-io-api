...
*DevicesApi* | [**patch_devices_tags_deviceuuid**](docs/DevicesApi.md#patch_devices_tags_deviceuuid) | **PATCH** /devices/tags/{deviceUuid} | Update the tags/attributes for a specific device
...
*FleetsApi* | [**get_fleets_fleetid_hardware_ids**](docs/FleetsApi.md#get_fleets_fleetid_hardware_ids) | **GET** /fleets/{fleetId}/hardware-ids | Get all hardware IDs for devices in a fleet
...
## Documentation For Models
 ...
 - [PaginationResultRefined](docs/PaginationResultRefined.md)
